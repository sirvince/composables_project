...
data class DataObject(
    ...
    @SerializedName("hasBirFormFiled") val hasBirFormFiled: Int,
    @SerializedName("is_complain") val isComplain: Int,
    @SerializedName("isRejected") val isRejected: Int,
    @SerializedName("payment_status") val paymentStatus: String,
    @SerializedName("payment_date") val paymentDate: String?,
    @SerializedName("payment_type") val paymentType: String?,
    @SerializedName("isPaidByApplicant") val isPaidByApplicant: Int,
    ...
    @SerializedName("has_official_receipt") val hasOfficialReceipt: Int,
    @SerializedName("ad_title") val adTitle: String,
    @SerializedName("tag_line") val tagLine: String?,
    @SerializedName("hasNoSubDocs") val hasNoSubDocs: Int,
    @SerializedName("is_maindoc_required") val isMainDocRequired: Int,
    ...
    @SerializedName("hasSubmitted") val hasSubmitted: Int,
    @SerializedName("internal_comment") val internalComment: String?,
    @SerializedName("external_comment") val externalComment: String?,
    @SerializedName("applicant_status") val applicantStatus: String,
    @SerializedName("internal_status") val internalStatus: String,
    ...
    @SerializedName("forCompliance") val forCompliance: Int,
    @SerializedName("forS2") val forS2: Int,
    @SerializedName("forRevision") val forRevision: Int,
    @SerializedName("forToa") val forToa: Int,
    ...
    @SerializedName("is_recent") val isRecent: Int,
    @SerializedName("revision_count") val revisionCount: Int,
    @SerializedName("company") val company: Company,
    @SerializedName("type_of_medium") val typeOfMedium: List<TypeOfMedium>,
    @SerializedName("assigned_user") val assignedUser: AssignedUser,
    @SerializedName("assigned_userRole") val assignedUserRole: AssignedUserRole,
    @SerializedName("evaluator") val evaluator: Evaluator,
